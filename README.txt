...
a persistence unit "sanchezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sanchez/pom.xml":
...
artifact ("sanchez.war") is already built. You can build
